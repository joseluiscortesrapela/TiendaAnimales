...
namespace Tienda.UserControls
{
    public partial class UC_CrudVentas : UserControl
    {
        ...
        public UC_CrudVentas(int idCliente)
        {
            InitializeComponent();
            // Obtengo solo las polizas del cliente y las muestro en el dgv
            dgvVentas.DataSource = AdminModel.getPolizasByClientID(idCliente);
        }
        ...
        private void dgvPolizas_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                filaPoliza = dgvVentas.Rows[e.RowIndex];
            ...
            if (pago == deboPagar)
            {
                ...
                if (AdminModel.pagarPoliza(pago, idPoliza) == 1)
                {
                    ...
                    {   // Actualizo las polizas del dgv
                        dgvVentas.DataSource = AdminModel.getPolizas();
